...
import com.example.jesta.databinding.FragmentTodoJestaBinding;
...
public class TodoJestaFragment extends Fragment {
    ...
    private FragmentTodoJestaBinding _binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        _binding = DataBindingUtil.inflate(inflater, R.layout.fragment_todo_jesta, container, false);
